...
function itemPreview(target, submitString, plugin_URL, hasRepository, objectData, addString) {
    'use strict';
    var url = plugin_URL;
    ...
    this.show = function() {
        ...
        for(var i=0;i<response.length;i++) {
            ...
            // When we change the state of the checkbox, create current itemlist.
            checkbox.addEventListener('click', function () {
                ...
                document.getElementById(target).value = items.join(";"); // Add items to moodle form field.
                $('#id_listitem_item').prop("checked", true); // If user select a video we assume they want to show a list.
            });
